...
// 	// for(i = 0; i < pdMS_TO_TICKS(delay); i++);
// 	for(i = 0; i < delay; i++) {
// 		for(j = 0; j < delay; j++);
// 	}
// }
...
void task2(){
    ...
    int distanceThreshold = 10;                                                                      //10 centimeters
    portTickType tickdistanceThreshold = pdMS_TO_TICKS((distanceThreshold * 58) / 1000);             //ticktype for distance threshold?
...
void task3(){
    ...
    int distance = (DISTANCE_IN_TICKS * 16 * 1000) / 58;
